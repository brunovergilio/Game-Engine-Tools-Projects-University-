#ifndef DIRECTIONALLIGHTSHADOWS_H
#define DIRECTIONALLIGHTSHADOWS_H
...
class DirectionalLightShadows : public Engine
{
public:
	DirectionalLightShadows(const char * const pWindowName, const unsigned int width, const unsigned int height);
